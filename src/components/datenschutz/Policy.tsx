    ...
    return (
        <section id="policy-details" className="container mx-auto px-4 py-12 text-gray-200">
            ...
            <p className="mb-4">
                ...
                <br /><br />
                <strong>Empfänger und Weitergabe:</strong> Empfänger der vorstehenden Daten sind zunächst wir als Betreiber, d.h. die Daten werden auf unseren Server-Protokollen erfasst. Darüber hinaus erhalten unsere Hosting-Dienstleister Zugriff auf die Daten als Auftragsverarbeiter:
                <ul className="list-disc pl-6 space-y-2 mt-2">
                    <li><strong>Cloudflare, Inc.</strong>, 101 Townsend St., San Francisco, CA 94107, USA (Cloudflare Germany GmbH, Rosental 7, c/o Mindspace, 80331 München als EU-Vertreter) – für CDN, DNS und Sicherheitsdienste. Cloudflare empfängt Ihre IP-Adresse und die oben genannten Verbindungsdaten, um die Anfrage zu verarbeiten. Diese Daten können in Cloudflare-Rechenzentren außerhalb Deutschlands (u.a. USA) zwischengespeichert werden; Cloudflare ist jedoch nach dem EU–US Data Privacy Framework zertifiziert und garantiert damit ein angemessenes Datenschutzniveau. Weitere Informationen finden Sie in der Cloudflare-Datenschutzerklärung.</li>
                    <li><strong>Railway, Inc. (USA)</strong> – Plattform zur Bereitstellung unseres Backend-Servers. Ihre Anfrage (inkl. IP, angefragter URL etc.) wird an unsere Anwendung weitergeleitet, die auf Railway gehostet ist. Railway verarbeitet diese Daten technisch als Host unseres Servers. Wir haben mit Railway einen Vertrag zur Auftragsverarbeitung (Data Processing Agreement) abgeschlossen. (Hinweis: Railway ist ein US-Dienst; bei Datenübertragung in die USA stützen wir uns auf Standardvertragsklauseln, da uns keine DPF-Zertifizierung bekannt ist – siehe Abschnitt zu Drittländern oben.)</li>
                    <li><strong>Eigenes Serverhosting (Coolify):</strong> Teile unseres Angebots werden auf einer selbst gehosteten Infrastruktur betrieben, die wir mit der Open-Source-Software Coolify verwalten. Dieses System läuft auf mehreren Server, darunter ein Server mit einem i7-12650H, sowie diversen älteren Servern um Redundanz zu gewährleisten, alle Server  befinden sich unter unserer Kontrolle (Standort Berlin - Deutschland - EU), so dass hier keine externen Empfänger auftreten. Die Log-Daten werden auf diesem Server gespeichert und unterliegen denselben Zwecken und Löschfristen wie insgesamt beschrieben.</li>
                </ul>
                <br />
